...
namespace QRScannerService_WindowsService
{
    public partial class QRScannerWindowsService : ServiceBase
    {
        ...
        private QRScannerService_Core.Interfaces.IExcelService _excelService; // Fully qualified name
        ...
        private void ConfigureServices()
        {
            ...
            services.AddSingleton<QRScannerService_Core.Interfaces.IExcelService, QRScannerService_Core.Services.ExcelService>(); // Fully qualified name
            services.AddSingleton<IWorkflowService, WorkflowService>();

            _serviceProvider = services.BuildServiceProvider();

            _serialPortService = _serviceProvider.GetRequiredService<ISerialPortService>();
            _excelService = _serviceProvider.GetRequiredService<QRScannerService_Core.Interfaces.IExcelService>(); // Fully qualified name
